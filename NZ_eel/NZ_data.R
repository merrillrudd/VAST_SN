...
# ## waikato densities 
waikato_dens_raw <- read.csv(file.path(data_dir, "Waikato Abundance.REC.csv"))
...
waikato_lengths_raw <- read.csv(file.path(data_dir, "Waikato Lengths.REC.csv"))[,c(7,12:13)]
...
saveRDS(waikato_len, file.path(data_dir, "Waikato_observations_length.rds"))
...
nz_longfin_eel$length <- waikato_len
